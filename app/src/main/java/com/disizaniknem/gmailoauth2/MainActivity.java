package com.disizaniknem.gmailoauth2;
...
import com.disizaniknem.gmailoauth2.helper.InternetDetector;
import com.disizaniknem.gmailoauth2.helper.Utils;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        sendButton = findViewById(R.id.btnSendMail);
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, String> {
        ...
        private String getDataFromApi() throws IOException {
            ...
            String user = "me";
            String to = "disizaniknem@gmail.com";
